...
from vllm.plugins.validation.policy import SignatureVerificationError
from vllm.plugins.validation.signature_enforcement import (
    register_model_validation_plugin)
...
def test_worker_adapter_manager_security_policy(dist_init, dummy_model_gate_up,
    ...
    with tempfile.NamedTemporaryFile(mode="w") as file:
        ...
        ModelValidationPluginRegistry.set_security_config(security_config)
